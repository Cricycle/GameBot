...
{
    /// <summary>
    /// Documentation located (and copied from) here: https://msdn.microsoft.com/en-us/library/ms644990(v=vs.85).aspx
    /// </summary>
    public enum IDHook
    {
        /// <summary>
        ...
        /// <summary>
        /// Installs a hook procedure that monitors messages after they have been processed by the destination
        /// window procedure. For more information, see the CallWndRetProc hook procedure.
        /// </summary>
